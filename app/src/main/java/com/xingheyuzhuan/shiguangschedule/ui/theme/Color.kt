...
val WakeUpDarkSurfaceVariant = Color(0xFF292C35)
val WakeUpDarkOnBackground = Color(0xFFE9EAF2)
val WakeUpDarkOnSurface = Color(0xFFE9EAF2)
val WakeUpDarkOnSurfaceVariant = Color(0xFFB8BAC7)
val WakeUpDarkSecondaryContainer = Color(0xFF30365F)
val WakeUpDarkOnSecondaryContainer = Color(0xFFE0E3FF)
val WakeUpDarkOutline = Color(0xFF484B59)

// 保留原有命名，避免其他主题或预览代码受到影响。
